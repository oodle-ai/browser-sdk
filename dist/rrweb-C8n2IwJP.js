var To = Object.defineProperty, _o = (s, e, t) => e in s ? To(s, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : s[e] = t, w = (s, e, t) => _o(s, typeof e != "symbol" ? e + "" : e, t), Ts, Fo = Object.defineProperty, Uo = (s, e, t) => e in s ? Fo(s, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : s[e] = t, _s = (s, e, t) => Uo(s, typeof e != "symbol" ? e + "" : e, t), V = /* @__PURE__ */ ((s) => (s[s.Document = 0] = "Document", s[s.DocumentType = 1] = "DocumentType", s[s.Element = 2] = "Element", s[s.Text = 3] = "Text", s[s.CDATA = 4] = "CDATA", s[s.Comment = 5] = "Comment", s))(V || {});
const Fs = {
  Node: [
    "childNodes",
    "parentNode",
...
}, ut = {}, Bo = () => !!globalThis.Zone;
function ls(s) {
  if (ut[s])
    return ut[s];
  const e = globalThis[s], t = e.prototype, r = s in Fs ? Fs[s] : void 0, i = !!(r && // @ts-expect-error 2345
  r.every(
    (l) => {
      var a, u;
      return !!((u = (a = Object.getOwnPropertyDescriptor(t, l)) == null ? void 0 : a.get) != null && u.toString().includes("[native code]"));
    }
  )), n = s in Us ? Us[s] : void 0, o = !!(n && n.every(
  ...
  if (i && o && !Bo())
    return ut[s] = e.prototype, e.prototype;
  try {
    ...
    return document.body.removeChild(l), u ? ut[s] = u : t;
  } catch {
    return t;
  }
}
...
function zo(s) {
  return fe("Node", s, "ownerDocument");
}
function Wo(s) {
  return fe("Node", s, "childNodes");
}
function Go(s) {
  return fe("Node", s, "parentNode");
}
function jo(s) {
  return fe("Node", s, "parentElement");
}
function Vo(s) {
  return fe("Node", s, "textContent");
}
function Ho(s, e) {
  return _i("Node", s, "contains")(e);
}
function Yo(s) {
  return _i("Node", s, "getRootNode")();
}
function Zo(s) {
  return !s || !("host" in s) ? null : fe("ShadowRoot", s, "host");
}
function Jo(s) {
  return s.styleSheets;
}
function Xo(s) {
  return !s || !("shadowRoot" in s) ? null : fe("Element", s, "shadowRoot");
}
function Ko(s, e) {
  return fe("Element", s, "querySelector")(e);
}
function Qo(s, e) {
  return fe("Element", s, "querySelectorAll")(e);
}
function qo() {
...
function Mr(s) {
  try {
    ...
    if (!e)
      return null;
    let t = s.href;
    !t && s.ownerNode && (t = s.ownerNode.baseURI);
    const r = Array.from(
      e,
      (i) => Ui(i, t)
    ).join("");
...
function Ui(s, e) {
  if (ia(s)) {
    ...
    try {
      ...
      Mr(s.styleSheet) || // work around browser issues with the raw string `@import url(...)` statement
      ra(s);
    } catch {
      t = s.cssText;
    }
...
class Bi {
  constructor() {
    _s(this, "idNodeMap", /* @__PURE__ */ new Map()), _s(this, "nodeMetaMap", /* @__PURE__ */ new WeakMap());
  }
  getId(e) {
    var t;
...
function aa(s) {
  ...
  for (let r = 0; r < s.width; r += t)
    for (let i = 0; i < s.height; i += t) {
      const n = e.getImageData, o = Bs in n ? n[Bs] : n;
      if (new Uint32Array(
...
const ua = /url\((?:(')([^']*)'|(")(.*?)"|([^)]*))\)/gm, ca = /^(?:[a-z+]+:)?\/\//i, ha = /^www\..*/i, fa = /^(data:)([^,]*),(.*)/i;
function zt(s, e) {
  return (s || "").replace(
    ua,
    (t, r, i, n, o, l) => {
      ...
      if (!a)
        return t;
      if (ca.test(a) || ha.test(a))
        return `url(${u}${a}${u})`;
      if (fa.test(a))
        return `url(${u}${a}${u})`;
      if (a[0] === "/")
        return `url(${u}${la(e) + a}${u})`;
...
function pa(s, e, t = !1) {
  const r = Array.from(e.childNodes), i = [];
  let n = 0;
  if (r.length > 1 && s && typeof s == "string") {
    let o = ct(s, t);
    const l = o.length / s.length;
    for (let a = 1; a < r.length; a++)
      if (r[a].textContent && typeof r[a].textContent == "string") {
        const u = ct(
          r[a].textContent,
          t
        ), c = 100;
        ...
        u.indexOf(u.substring(0, h), 1) !== -1); h++)
          ;
        for (; h < u.length; h++) {
          let d = u.substring(0, h), g = o.split(d), m = -1;
          if (g.length === 2)
            m = g[0].length;
          else if (g.length > 2 && g[0] === "" && r[a - 1].textContent !== "")
            m = o.indexOf(d, 1);
          else if (g.length === 1) {
            if (d = d.substring(
              0,
              d.length - 1
            ), g = o.split(d), g.length <= 1)
              return i.push(s), i;
            h = c + 1;
          } else h === u.length - 1 && (m = o.indexOf(d));
          if (g.length >= 2 && h > c) {
            const p = r[a - 1].textContent;
          ...
          if (m !== -1) {
            let p = Math.floor(m / l);
            for (; p > 0 && p < s.length; ) {
              if (n += 1, n > 50 * r.length)
                return i.push(s), i;
              const f = ct(
                s.substring(0, p),
                t
              ...
              if (f.length === m) {
                i.push(s.substring(0, p)), s = s.substring(p), o = o.substring(m);
                break;
              } else f.length < m ? p += Math.max(
                1,
                Math.floor((m - f.length) / l)
              ) : p -= Math.max(
                1,
                Math.floor((f.length - m) * l)
              );
            }
            break;
          }
...
function da(s, e) {
  return pa(s, e).join("/* rr_split */");
}
let ma = 1;
const ga = new RegExp("[^a-z0-9-_:]"), He = -2;
function Wi() {
  return ma++;
}
function ya(s) {
  if (s instanceof HTMLFormElement)
    return "form";
  const e = Se(s.tagName);
  return ga.test(e) ? "div" : e;
}
let xe, zs;
const wa = /^[^ \t\n\r\u000c]+/, Sa = /^[, \t\n\r\u000c]+/;
function ba(s, e) {
  ...
  for (; r(Sa), !(t >= e.length); ) {
    let n = r(wa);
    if (n.slice(-1) === ",")
      n = Ae(s, n.substring(0, n.length - 1)), i.push(n);
    else {
      let o = "";
      n = Ae(s, n);
      let l = !1;
...
function us(s, e) {
  let t = Ws.get(s);
  if (t || (t = s.createElement("a"), Ws.set(s, t)), !e)
    e = "";
...
function Gi(s, e, t, r) {
  return r && (t === "src" || t === "href" && !(e === "use" && r[0] === "#") || t === "xlink:href" && r[0] !== "#" || t === "background" && ["table", "td", "th"].includes(e) ? Ae(s, r) : t === "srcset" ? ba(s, r) : t === "style" ? zt(r, us(s)) : e === "object" && t === "data" ? Ae(s, r) : r);
}
function ji(s, e, t) {
  return ["video", "audio"].includes(s) && e === "autoplay";
}
function va(s, e, t) {
  try {
    if (typeof e == "string") {
...
function Wt(s, e, t) {
  ...
  if (s.nodeType !== s.ELEMENT_NODE)
    return t ? Wt(Y.parentNode(s), e, t) : !1;
  for (let r = s.classList.length; r--; ) {
    const i = s.classList[r];
    if (e.test(i))
      return !0;
...
function Aa(s, e) {
  ...
  return c ? a = "SCRIPT_PLACEHOLDER" : n || (a = Y.textContent(s), u && a && (a = zt(a, us(e.doc)))), !u && !c && a && t && (a = r ? r(a, Y.parentElement(s)) : a.replace(/[\S]/g, "*")), {
    type: V.Text,
    textContent: a || "",
    rootId: i
  };
...
function Ma(s, e) {
  ...
  for (let y = 0; y < S; y++) {
    ...
    ji(p, C.name, C.value) || (f[C.name] = Gi(
      t,
      p,
      Se(C.name),
      C.value
  ...
  if (p === "link" && n) {
    ...
    let C = null;
    y && (C = Mr(y)), C && (delete f.rel, delete f.href, f._cssText = C);
  }
  if (p === "style" && s.sheet) {
    let y = Mr(
      s.sheet
    );
    y && (s.childNodes.length > 1 && (y = da(y, s)), f._cssText = y);
  }
  if (["input", "textarea", "select"].includes(p)) {
    const y = s.value, C = s.checked;
    f.type !== "radio" && f.type !== "checkbox" && f.type !== "submit" && f.type !== "button" && y ? f.value = Ut({
      element: s,
      type: Bt(s),
      tagName: p,
      value: y,
  ...
  if (p === "img" && u) {
    xe || (xe = t.createElement("canvas"), zs = xe.getContext("2d"));
    const y = s, C = y.currentSrc || y.getAttribute("src") || "<unknown-src>", $ = y.crossOrigin, k = () => {
      y.removeEventListener("load", k);
      try {
        xe.width = y.naturalWidth, xe.height = y.naturalHeight, zs.drawImage(y, 0, 0), f.rr_dataURL = xe.toDataURL(
          a.type,
          a.quality
        );
      } catch (G) {
        if (y.crossOrigin !== "anonymous") {
          ...
          console.warn(
            `Cannot inline img src=${C}! Error: ${G}`
          );
      }
  ...
  if (d || (s.scrollLeft && (f.rr_scrollLeft = s.scrollLeft), s.scrollTop && (f.rr_scrollTop = s.scrollTop)), m) {
...
function Hi(s) {
  return s === !0 || s === "all" ? {
    ...
    headTitleMutations: s === "all"
  } : s || {};
}
function Ea(s, e) {
  if (e.comment && s.type === V.Comment)
    return !0;
  if (s.type === V.Element) {
    ...
    s.tagName === "link" && s.attributes.rel === "prefetch" && typeof s.attributes.href == "string" && zi(s.attributes.href) === "js"))
      return !0;
    if (e.headFavicon && (s.tagName === "link" && s.attributes.rel === "shortcut icon" || s.tagName === "meta" && (P(s.attributes.name).match(
      /^msapplication-tile(image|color)$/
    ) || P(s.attributes.name) === "application-name" || P(s.attributes.rel) === "icon" || P(s.attributes.rel) === "apple-touch-icon" || P(s.attributes.rel) === "shortcut icon")))
      return !0;
    if (s.tagName === "meta") {
      if (e.headMetaDescKeywords && P(s.attributes.name).match(/^description|keywords$/))
        return !0;
      if (e.headMetaSocial && (P(s.attributes.property).match(/^(og|twitter|fb):/) || // og = opengraph (facebook)
      P(s.attributes.name).match(/^(og|twitter):/) || P(s.attributes.name) === "pinterest"))
        return !0;
      if (e.headMetaRobots && (P(s.attributes.name) === "robots" || P(s.attributes.name) === "googlebot" || P(s.attributes.name) === "bingbot"))
        return !0;
      if (e.headMetaHttpEquiv && s.attributes["http-equiv"] !== void 0)
        return !0;
      if (e.headMetaAuthorship && (P(s.attributes.name) === "author" || P(s.attributes.name) === "generator" || P(s.attributes.name) === "framework" || P(s.attributes.name) === "publisher" || P(s.attributes.name) === "progid" || P(s.attributes.property).match(/^article:/) || P(s.attributes.property).match(/^product:/)))
        return !0;
      if (e.headMetaVerification && (P(s.attributes.name) === "google-site-verification" || P(s.attributes.name) === "yandex-verification" || P(s.attributes.name) === "csrf-token" || P(s.attributes.name) === "p:domain_verify" || P(s.attributes.name) === "verify-v1" || P(s.attributes.name) === "verification" || P(s.attributes.name) === "shopify-checkout-api-token"))
        return !0;
    }
  }
  return !1;
...
function Me(s, e) {
  ...
  let ne;
  r.hasNode(s) ? ne = r.getId(s) : Ea(Q, g) || !H && Q.type === V.Text && !Q.textContent.replace(/^\s+|\s+$/gm, "").length ? ne = He : ne = Wi();
  const O = Object.assign(Q, { id: ne });
  if (r.add(s, O), ne === He)
    return null;
  S && S(s);
  let _e = !a;
  if (O.type === V.Element) {
    _e = _e && !O.needBlock, delete O.needBlock;
    const j = Y.shadowRoot(s);
    j && je(j) && (O.isShadowHost = !0);
  }
  if ((O.type === V.Document || O.type === V.Element) && _e) {
    g.headWhitespace && O.type === V.Element && O.tagName === "head" && (H = !1);
    const j = {
      doc: t,
      mirror: r,
      blockClass: i,
    ...
    if (!(O.type === V.Element && O.tagName === "textarea" && O.attributes.value !== void 0)) {
      O.type === V.Element && O.attributes._cssText !== void 0 && typeof O.attributes._cssText == "string" && (j.cssCaptured = !0);
      for (const me of Array.from(Y.childNodes(s))) {
        const oe = Me(me, j);
        oe && O.childNodes.push(oe);
      }
    }
    let q = null;
    if (Fi(s) && (q = Y.shadowRoot(s)))
      for (const me of Array.from(Y.childNodes(q))) {
        const oe = Me(me, j);
        oe && (je(q) && (oe.isShadow = !0), O.childNodes.push(oe));
      }
  }
  const Fe = Y.parentNode(s);
  return Fe && Ge(Fe) && je(Fe) && (O.isShadow = !0), O.type === V.Element && O.tagName === "iframe" && Ia(
    s,
    () => {
    ...
    y
  ), O.type === V.Element && O.tagName === "link" && typeof O.attributes.rel == "string" && (O.attributes.rel === "stylesheet" || O.attributes.rel === "preload" && typeof O.attributes.href == "string" && zi(O.attributes.href) === "css") && xa(
    s,
    () => {
      if (C) {
        const j = Me(s, {
...
var cs = { exports: {} }, D = String, Yi = function() {
...
cs.exports = Yi();
cs.exports.createColors = Yi;
var Pa = cs.exports;
const Da = {}, La = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: Da
}, Symbol.toStringTag, { value: "Module" })), se = /* @__PURE__ */ ka(La);
let Gs = Pa, js = se, Er = class Zi extends Error {
  constructor(e, t, r, i, n, o) {
    super(e), this.name = "CssSyntaxError", this.reason = e, n && (this.file = n), i && (this.source = i), o && (this.plugin = o), typeof t < "u" && typeof r < "u" && (typeof t == "number" ? (this.line = t, this.column = r) : (this.line = t.line, this.column = t.column, this.endLine = r.line, this.endColumn = r.column)), this.setMessage(), Error.captureStackTrace && Error.captureStackTrace(this, Zi);
  }
  setMessage() {
  ...
  showSourceCode(e) {
    ...
    let t = this.source;
    e == null && (e = Gs.isColorSupported), js && e && (t = js(t));
    let r = t.split(/\r?\n/), i = Math.max(this.line - 3, 0), n = Math.min(this.line + 2, r.length), o = String(n).length, l, a;
    if (e) {
      let { bold: u, gray: c, red: h } = Gs.createColors(!0);
      l = (d) => u(h(d)), a = (d) => c(d);
    } else
      l = a = (u) => u;
    return r.slice(i, n).map((u, c) => {
      ...
      if (h === this.line) {
        let g = a(d.replace(/\d/g, " ")) + u.slice(0, this.column - 1).replace(/[^\t]/g, " ");
        return l(">") + a(d) + u + `
 ` + g + l("^");
      }
      return " " + a(d) + u;
...
`)) {
  ...
  raw(e, t, r) {
    ...
    return typeof i > "u" && (i = Vs[r]), o.rawCache[r] = i, i;
  }
  rawBeforeClose(e) {
    let t;
    return e.walk((r) => {
...
let _a = Ji;
function Nr(s, e) {
  new _a(e).stringify(s);
}
var er = Nr;
Nr.default = Nr;
let { isClean: ht, my: Fa } = rt, Ua = hs, Ba = Ji, za = er;
function kr(s, e) {
...
var rr = Dr;
Dr.default = Dr;
let Ga = "useandom-26T198340PX75pxJACKVERYMINDBUSHWOLF_GQZbfghjklqvwyzrict", ja = (s = 21) => {
  let e = "", t = s;
  for (; t--; )
...
var Va = { nanoid: ja };
let { SourceMapConsumer: Hs, SourceMapGenerator: Ys } = se, { existsSync: Ha, readFileSync: Ya } = se, { dirname: gr, join: Za } = se;
function Ja(s) {
...
let Lr = class {
  ...
  consumer() {
    return this.consumerCache || (this.consumerCache = new Hs(this.text)), this.consumerCache;
  }
  decodeInline(e) {
    ...
    if (t.test(e) || r.test(e))
      return Ja(e.substr(RegExp.lastMatch.length));
  ...
  loadFile(e) {
    if (this.root = gr(e), Ha(e))
      return this.mapFile = e, Ya(e, "utf-8").toString().trim();
  }
  loadMap(e, t) {
    if (t === !1) return !1;
    if (t) {
      ...
      if (this.annotation) {
        ...
        return e && (r = Za(gr(e), r)), this.loadFile(r);
      }
    }
  }
  startWith(e, t) {
...
var Xi = Lr;
Lr.default = Lr;
let { SourceMapConsumer: Xa, SourceMapGenerator: Ka } = se, { fileURLToPath: Zs, pathToFileURL: ft } = se, { isAbsolute: Tr, resolve: _r } = se, { nanoid: Qa } = Va, yr = se, Js = hs, qa = Xi, wr = Symbol("fromOffsetCache"), el = !!(Xa && Ka), Xs = !!(_r && Tr), Gt = class {
  constructor(e, t = {}) {
    if (e === null || typeof e > "u" || typeof e == "object" && !e.toString)
      throw new Error(`PostCSS received ${e} instead of CSS string`);
    if (this.css = e.toString(), this.css[0] === "\uFEFF" || this.css[0] === "￾" ? (this.hasBOM = !0, this.css = this.css.slice(1)) : this.hasBOM = !1, t.from && (!Xs || /^\w+:\/\//.test(t.from) || Tr(t.from) ? this.file = t.from : this.file = _r(t.from)), Xs && el) {
    ...
    this.file || (this.id = "<input css " + Qa(6) + ">"), this.map && (this.map.file = this.from);
  }
  error(e, t, r, i = {}) {
    let n, o, l;
    ...
    return a ? n = new Js(
      ...
      this.file,
      i.plugin
    ), n.input = { column: r, endColumn: l, endLine: o, line: t, source: this.css }, this.file && (ft && (n.input.url = ft(this.file).toString()), n.input.file = this.file), n;
  }
  fromOffset(e) {
    let t, r;
    if (this[wr])
...
`);
  ...
  origin(e, t, r, i) {
    ...
    let a;
    Tr(o.source) ? a = ft(o.source) : a = new URL(
      o.source,
...
var sr = Gt;
Gt.default = Gt;
yr && yr.registerInput && yr.registerInput(Gt);
let { SourceMapConsumer: Ki, SourceMapGenerator: Pt } = se, { dirname: Dt, relative: Qi, resolve: qi, sep: en } = se, { pathToFileURL: Ks } = se, tl = sr, rl = !!(Ki && Pt), sl = !!(Dt && qi && Qi && en), il = class {
  constructor(e, t, r, i) {
...
`), this.css += t + "/*# sourceMappingURL=" + e + " */";
  ...
  applyPrevMaps() {
    for (let e of this.previous()) {
      let t = this.toUrl(this.path(e.file)), r = e.root || Dt(e.file), i;
      this.mapOpts.sourcesContent === !1 ? (i = new Ki(e.text), i.sourcesContent && (i.sourcesContent = null)) : i = e.consumer(), this.map.applySourceMap(i, t, this.toUrl(this.path(r)));
    }
  }
  clearAnnotation() {
...
`), t = l.length - o) : t += l.length, a && u !== "start") {
  ...
  path(e) {
    ...
    if (t) return t;
    let r = this.opts.to ? Dt(this.opts.to) : ".";
    typeof this.mapOpts.annotation == "string" && (r = Dt(qi(r, this.mapOpts.annotation)));
    let i = Qi(r, e);
...
var ir = Fr;
Fr.default = Fr;
let { isClean: rn, my: sn } = rt, nn = rr, on = ir, ol = tr, an, fs, ps, ln;
function un(s) {
  return s.map((e) => (e.nodes && (e.nodes = un(e.nodes)), delete e.source, e));
}
function cn(s) {
  if (s[rn] = !1, s.proxyOf.nodes)
    for (let e of s.proxyOf.nodes)
      cn(e);
}
let ce = class hn extends ol {
  append(...e) {
    for (let t of e) {
  ...
  normalize(e, t) {
    if (typeof e == "string")
      ...
      typeof e.value != "string" && (e.value = String(e.value)), e = [new nn(e)];
    } else if (e.selector)
      e = [new fs(e)];
    else if (e.name)
      e = [new ps(e)];
    ...
    return e.map((i) => (i[sn] || hn.rebuild(i), i = i.proxyOf, i.parent && i.parent.removeChild(i), i[rn] && cn(i), typeof i.raws.before > "u" && t && typeof t.raws.before < "u" && (i.raws.before = t.raws.before.replace(/\S/g, "")), i.parent = this.proxyOf, i));
  }
  prepend(...e) {
    e = e.reverse();
    for (let t of e) {
...
ce.default = ce;
ce.rebuild = (s) => {
  s.type === "atrule" ? Object.setPrototypeOf(s, ps.prototype) : s.type === "rule" ? Object.setPrototypeOf(s, fs.prototype) : s.type === "decl" ? Object.setPrototypeOf(s, nn.prototype) : s.type === "comment" ? Object.setPrototypeOf(s, on.prototype) : s.type === "root" && Object.setPrototypeOf(s, ln.prototype), s[sn] = !0, s.nodes && s.nodes.forEach((e) => {
    ce.rebuild(e);
  });
};
let al = be, fn, pn, Ye = class extends al {
  constructor(e) {
    super({ type: "document", ...e }), this.nodes || (this.nodes = []);
  }
  toResult(e = {}) {
    return new fn(new pn(), this, e).stringify();
  }
};
Ye.registerLazyResult = (s) => {
  fn = s;
};
Ye.registerProcessor = (s) => {
  pn = s;
};
var ds = Ye;
Ye.default = Ye;
let Qs = {};
var dn = function(e) {
  Qs[e] || (Qs[e] = !0, typeof console < "u" && console.warn && console.warn(e));
};
let Ur = class {
  constructor(e, t = {}) {
...
var ms = Br;
Br.default = Br;
const Sr = 39, qs = 34, pt = 92, ei = 47, dt = 10, Ue = 32, mt = 12, gt = 9, yt = 13, ul = 91, cl = 93, hl = 40, fl = 41, pl = 123, dl = 125, ml = 59, gl = 42, yl = 58, wl = 64, wt = /[\t\n\f\r "#'()/;[\\\]{}]/g, St = /[\t\n\f\r !"#'():;@[\\\]{}]|\/(?=\*)/g, Sl = /.[\r\n"'(/\\]/, ti = /[\da-f]/i;
var bl = function(e, t = {}) {
  let r = e.css.valueOf(), i = t.ignoreErrors, n, o, l, a, u, c, h, d, g, m, p = r.length, f = 0, S = [], b = [];
  function y() {
    return f;
  }
  function C(T) {
  ...
  function k(T) {
    ...
    switch (n = r.charCodeAt(f), n) {
      ...
      case mt: {
        ...
        while (n === Ue || n === dt || n === gt || n === yt || n === mt);
        m = ["space", r.slice(f, o)], f = o - 1;
        break;
      }
      case ul:
      case cl:
      ...
      case hl: {
        if (d = S.length ? S.pop()[1] : "", g = r.charCodeAt(f + 1), d === "url" && g !== Sr && g !== qs && g !== Ue && g !== dt && g !== gt && g !== mt && g !== yt) {
          o = f;
          do {
            if (c = !1, o = r.indexOf(")", o + 1), o === -1)
              if (i || W) {
                ...
                C("bracket");
            for (h = o; r.charCodeAt(h - 1) === pt; )
              h -= 1, c = !c;
          } while (c);
          m = ["brackets", r.slice(f, o + 1), f, o], f = o;
        } else
          o = r.indexOf(")", f + 1), a = r.slice(f, o + 1), o === -1 || Sl.test(a) ? m = ["(", "(", f] : (m = ["brackets", a, f, o], f = o);
        break;
      }
      case Sr:
      case qs: {
        ...
        m = ["string", r.slice(f, o + 1), f, o], f = o;
        break;
      }
      case wl: {
        wt.lastIndex = f + 1, wt.test(r), wt.lastIndex === 0 ? o = r.length - 1 : o = wt.lastIndex - 2, m = ["at-word", r.slice(f, o + 1), f, o], f = o;
        break;
      }
      case pt: {
        for (o = f, u = !0; r.charCodeAt(o + 1) === pt; )
          o += 1, u = !u;
        if (n = r.charCodeAt(o + 1), u && n !== ei && n !== Ue && n !== dt && n !== gt && n !== yt && n !== mt && (o += 1, ti.test(r.charAt(o)))) {
          for (; ti.test(r.charAt(o + 1)); )
            o += 1;
          r.charCodeAt(o + 1) === Ue && (o += 1);
        }
        m = ["word", r.slice(f, o + 1), f, o], f = o;
        break;
      }
      default: {
        n === ei && r.charCodeAt(f + 1) === gl ? (o = r.indexOf("*/", f + 2) + 1, o === 0 && (i || W ? o = r.length : C("comment")), m = ["comment", r.slice(f, o + 1), f, o], f = o) : (St.lastIndex = f + 1, St.test(r), St.lastIndex === 0 ? o = r.length - 1 : o = St.lastIndex - 2, m = ["word", r.slice(f, o + 1), f, o], S.push(m), f = o);
        break;
      }
    }
    return f++, m;
...
var gs = jt;
jt.default = jt;
gn.registerAtRule(jt);
let yn = be, wn, Sn, $e = class extends yn {
  constructor(e) {
  ...
  toResult(e = {}) {
    return new wn(new Sn(), this, e).stringify();
  }
};
$e.registerLazyResult = (s) => {
  wn = s;
};
$e.registerProcessor = (s) => {
  Sn = s;
};
var st = $e;
$e.default = $e;
...
var bn = Ze;
Ze.default = Ze;
let Cn = be, Cl = bn, Vt = class extends Cn {
  constructor(e) {
    super(e), this.type = "rule", this.nodes || (this.nodes = []);
  }
  get selectors() {
    return Cl.comma(this.selector);
  }
  set selectors(e) {
...
Vt.default = Vt;
Cn.registerRule(Vt);
let vl = rr, Il = bl, xl = ir, Rl = gs, Ol = st, ri = ys;
const si = {
  empty: !0,
  space: !0
};
...
let Ml = class {
  constructor(e) {
    this.input = e, this.root = new Ol(), this.current = this.root, this.spaces = "", this.semicolon = !1, this.createTokenizer(), this.root.source = { input: e, start: { column: 1, line: 1, offset: 0 } };
  }
  atrule(e) {
    let t = new Rl();
  ...
  raw(e, t, r, i) {
    ...
    for (let d = 0; d < l; d += 1)
      n = r[d], o = n[0], o === "space" && d === l - 1 && !i ? u = !1 : o === "comment" ? (h = r[d - 1] ? r[d - 1][0] : "empty", c = r[d + 1] ? r[d + 1][0] : "empty", !si[h] && !si[c] ? a.slice(-1) === "," ? u = !1 : a += n[1] : u = !1) : a += n[1];
    if (!u) {
      let d = r.reduce((g, m) => g + m[1], "");
...
var El = Ml;
let $l = be, Nl = El, kl = sr;
function Ht(s, e) {
  let t = new kl(s, e), r = new Nl(t);
  try {
    r.parse();
  } catch (i) {
...
Ht.default = Ht;
$l.registerParse(Ht);
let { isClean: ae, my: Pl } = rt, Dl = tn, Ll = er, Tl = be, _l = ds, Fl = dn, ii = ms, Ul = ws, Bl = st;
const zl = {
  atrule: "AtRule",
  comment: "Comment",
  decl: "Declaration",
...
function vn(s) {
  ...
  return s.type === "decl" ? e = s.prop.toLowerCase() : s.type === "atrule" && (e = s.name.toLowerCase()), e && s.append ? [
    ...
    t + "Exit",
    t + "Exit-" + e
  ] : e ? [t, t + "-" + e, t + "Exit", t + "Exit-" + e] : s.append ? [t, Ne, t + "Exit"] : [t, t + "Exit"];
}
function ni(s) {
  let e;
  return s.type === "document" ? e = ["Document", Ne, "DocumentExit"] : s.type === "root" ? e = ["Root", Ne, "RootExit"] : e = vn(s), {
    eventIndex: 0,
    events: e,
    iterator: 0,
    node: s,
...
function zr(s) {
  return s[ae] = !1, s.nodes && s.nodes.forEach((e) => zr(e)), s;
}
let Wr = {}, ke = class In {
  constructor(e, t, r) {
    ...
    if (typeof t == "object" && t !== null && (t.type === "root" || t.type === "document"))
      i = zr(t);
    else if (t instanceof In || t instanceof ii)
      i = zr(t.root), t.map && (typeof r.map > "u" && (r.map = {}), r.map.inline || (r.map.inline = !1), r.map.prev = t.map);
    else {
      let n = Ul;
    ...
    this.result = new ii(e, i, r), this.helpers = { ...Wr, postcss: Wr, result: this.result }, this.plugins = this.processor.plugins.map((n) => typeof n == "object" && n.prepare ? { ...n, ...n.prepare(this.result) } : n);
  }
  async() {
  ...
  stringify() {
    ...
    let e = this.result.opts, t = Ll;
    e.syntax && (t = e.syntax.stringify), e.stringifier && (t = e.stringifier), t.stringify && (t = t.stringify);
    let i = new Dl(t, this.result.root, this.result.opts).generate();
  ...
  then(e, t) {
    return process.env.NODE_ENV !== "production" && ("from" in this.opts || Fl(
  ...
  visitTick(e) {
    ...
    for (; t.eventIndex < n.length; ) {
      ...
      if (t.eventIndex += 1, o === Ne) {
        r.nodes && r.nodes.length && (r[ae] = !0, t.iterator = r.getIterator());
        return;
...
var xn = ke;
ke.default = ke;
Bl.registerLazyResult(ke);
_l.registerLazyResult(ke);
let jl = tn, Vl = er, Hl = dn, Yl = ws;
const Zl = ms;
let Gr = class {
  constructor(e, t, r) {
    t = t.toString(), this.stringified = !1, this._processor = e, this._css = t, this._opts = r, this._map = void 0;
    let i, n = Vl;
    this.result = new Zl(this._processor, i, this._opts), this.result.css = t;
    let o = this;
...
var Jl = Gr;
Gr.default = Gr;
let Xl = Jl, Kl = xn, Ql = ds, ql = st, Je = class {
  constructor(e = []) {
  ...
  process(e, t = {}) {
    return !this.plugins.length && !t.parser && !t.stringifier && !t.syntax ? new Xl(this, e, t) : new Kl(this, e, t);
  }
  use(e) {
...
var eu = Je;
Je.default = Je;
ql.registerProcessor(Je);
Ql.registerProcessor(Je);
let tu = rr, ru = Xi, su = ir, iu = gs, nu = sr, ou = st, au = ys;
function Xe(s, e) {
  if (Array.isArray(s)) return s.map((i) => Xe(i));
  let { inputs: t, ...r } = s;
  if (t) {
    e = [];
    for (let i of t) {
      let n = { ...i, __proto__: nu.prototype };
      n.map && (n.map = {
        ...n.map,
  ...
  if (r.nodes && (r.nodes = s.nodes.map((i) => Xe(i, e))), r.source) {
...
var lu = Xe;
Xe.default = Xe;
let uu = hs, Rn = rr, cu = xn, hu = be, Ss = eu, fu = er, pu = lu, On = ds, du = mn, An = ir, Mn = gs, mu = ms, gu = sr, yu = ws, wu = bn, En = ys, $n = st, Su = tr;
function M(...s) {
  return s.length === 1 && Array.isArray(s[0]) && (s = s[0]), new Ss(s);
}
...
https://www.w3ctech.com/topic/2226`
    ...
    let l = t(...o);
    return l.postcssPlugin = e, l.postcssVersion = new Ss().version, l;
  }
  let n;
...
M.fromJSON = pu;
M.list = wu;
M.comment = (s) => new An(s);
M.atRule = (s) => new Mn(s);
M.decl = (s) => new Rn(s);
M.rule = (s) => new En(s);
M.root = (s) => new $n(s);
M.document = (s) => new On(s);
M.CssSyntaxError = uu;
M.Declaration = Rn;
M.Container = hu;
M.Processor = Ss;
...
M.Root = $n;
M.Node = Su;
cu.registerPostcss(M);
var bu = M;
M.default = M;
const _ = /* @__PURE__ */ Na(bu);
_.stringify;
_.fromJSON;
_.plugin;
_.parse;
...
_.Root;
_.Node;
var Cu = Object.defineProperty, vu = (s, e, t) => e in s ? Cu(s, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : s[e] = t, ee = (s, e, t) => vu(s, typeof e != "symbol" ? e + "" : e, t);
function Iu(s) {
  return s && s.__esModule && Object.prototype.hasOwnProperty.call(s, "default") ? s.default : s;
}
function xu(s) {
...
var bs = { exports: {} }, L = String, Nn = function() {
...
bs.exports = Nn();
bs.exports.createColors = Nn;
var Ru = bs.exports;
const Ou = {}, Au = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: Ou
}, Symbol.toStringTag, { value: "Module" })), ie = /* @__PURE__ */ xu(Au);
let oi = Ru, ai = ie, jr = class kn extends Error {
  constructor(e, t, r, i, n, o) {
    super(e), this.name = "CssSyntaxError", this.reason = e, n && (this.file = n), i && (this.source = i), o && (this.plugin = o), typeof t < "u" && typeof r < "u" && (typeof t == "number" ? (this.line = t, this.column = r) : (this.line = t.line, this.column = t.column, this.endLine = r.line, this.endColumn = r.column)), this.setMessage(), Error.captureStackTrace && Error.captureStackTrace(this, kn);
  }
  setMessage() {
    this.message = this.plugin ? this.plugin + ": " : "", this.message += this.file ? this.file : "<css input>", typeof this.line < "u" && (this.message += ":" + this.line + ":" + this.column), this.message += ": " + this.reason;
  }
  showSourceCode(e) {
    if (!this.source) return "";
    let t = this.source;
    e == null && (e = oi.isColorSupported), ai && e && (t = ai(t));
    let r = t.split(/\r?\n/), i = Math.max(this.line - 3, 0), n = Math.min(this.line + 2, r.length), o = String(n).length, l, a;
    if (e) {
      let { bold: u, gray: c, red: h } = oi.createColors(!0);
      l = (d) => u(h(d)), a = (d) => c(d);
    } else
      l = a = (u) => u;
    return r.slice(i, n).map((u, c) => {
...
`)) {
  ...
  raw(e, t, r) {
    ...
    return typeof i > "u" && (i = li[r]), o.rawCache[r] = i, i;
  }
  rawBeforeClose(e) {
    let t;
    return e.walk((r) => {
...
var nr = Hr;
Hr.default = Hr;
let { isClean: bt, my: $u } = it, Nu = Cs, ku = Pn, Pu = nr;
function Yr(s, e) {
  let t = new s.constructor();
  for (let r in s) {
    if (!Object.prototype.hasOwnProperty.call(s, r) || r === "proxyCache") continue;
    let i = s[r], n = typeof i;
    r === "parent" && n === "object" ? e && (t[r] = e) : r === "source" ? t[r] = i : Array.isArray(i) ? t[r] = i.map((o) => Yr(o, t)) : (n === "object" && i !== null && (i = Yr(i)), t[r] = i);
  }
  return t;
}
let Zr = class {
  constructor(e = {}) {
    this.raws = {}, this[bt] = !1, this[$u] = !0;
    for (let t in e)
      if (t === "nodes") {
        this.nodes = [];
        for (let r of e[t])
...
var ar = Jr;
Jr.default = Jr;
let Lu = "useandom-26T198340PX75pxJACKVERYMINDBUSHWOLF_GQZbfghjklqvwyzrict", Tu = (s = 21) => {
  let e = "", t = s;
  for (; t--; )
    e += Lu[Math.random() * 64 | 0];
  return e;
};
var _u = { nanoid: Tu };
let { SourceMapConsumer: ui, SourceMapGenerator: ci } = ie, { existsSync: Fu, readFileSync: Uu } = ie, { dirname: br, join: Bu } = ie;
function zu(s) {
  return Buffer ? Buffer.from(s, "base64").toString() : window.atob(s);
}
let Xr = class {
  ...
  consumer() {
    return this.consumerCache || (this.consumerCache = new ui(this.text)), this.consumerCache;
  }
  decodeInline(e) {
    let t = /^data:application\/json;charset=utf-?8;base64,/, r = /^data:application\/json;base64,/, i = /^data:application\/json;charset=utf-?8,/, n = /^data:application\/json,/;
    if (i.test(e) || n.test(e))
      return decodeURIComponent(e.substr(RegExp.lastMatch.length));
    if (t.test(e) || r.test(e))
      return zu(e.substr(RegExp.lastMatch.length));
    let o = e.match(/data:application\/json;([^,]+),/)[1];
    throw new Error("Unsupported source map encoding " + o);
  }
  getAnnotationURL(e) {
  ...
  loadFile(e) {
    if (this.root = br(e), Fu(e))
      return this.mapFile = e, Uu(e, "utf-8").toString().trim();
  }
  loadMap(e, t) {
    if (t === !1) return !1;
    if (t) {
      ...
      if (typeof t == "function") {
        ...
        if (t instanceof ui)
          return ci.fromSourceMap(t).toString();
        if (t instanceof ci)
          return t.toString();
        if (this.isMap(t))
          return JSON.stringify(t);
      ...
      if (this.annotation) {
        let r = this.annotation;
        return e && (r = Bu(br(e), r)), this.loadFile(r);
      }
    }
  }
  startWith(e, t) {
...
var Dn = Xr;
Xr.default = Xr;
let { SourceMapConsumer: Wu, SourceMapGenerator: Gu } = ie, { fileURLToPath: hi, pathToFileURL: Ct } = ie, { isAbsolute: Kr, resolve: Qr } = ie, { nanoid: ju } = _u, Cr = ie, fi = Cs, Vu = Dn, vr = Symbol("fromOffsetCache"), Hu = !!(Wu && Gu), pi = !!(Qr && Kr), Yt = class {
  constructor(e, t = {}) {
    if (e === null || typeof e > "u" || typeof e == "object" && !e.toString)
      throw new Error(`PostCSS received ${e} instead of CSS string`);
    if (this.css = e.toString(), this.css[0] === "\uFEFF" || this.css[0] === "￾" ? (this.hasBOM = !0, this.css = this.css.slice(1)) : this.hasBOM = !1, t.from && (!pi || /^\w+:\/\//.test(t.from) || Kr(t.from) ? this.file = t.from : this.file = Qr(t.from)), pi && Hu) {
      let r = new Vu(this.css, t);
      if (r.text) {
        this.map = r;
        let i = r.consumer().file;
        !this.file && i && (this.file = this.mapResolve(i));
    ...
    this.file || (this.id = "<input css " + ju(6) + ">"), this.map && (this.map.file = this.from);
  }
  error(e, t, r, i = {}) {
    let n, o, l;
    if (t && typeof t == "object") {
    ...
    return a ? n = new fi(
      ...
      this.file,
      i.plugin
    ), n.input = { column: r, endColumn: l, endLine: o, line: t, source: this.css }, this.file && (Ct && (n.input.url = Ct(this.file).toString()), n.input.file = this.file), n;
  }
  fromOffset(e) {
    let t, r;
    if (this[vr])
...
`);
  ...
  origin(e, t, r, i) {
    ...
    typeof r == "number" && (l = n.originalPositionFor({ column: i, line: r }));
    let a;
    Kr(o.source) ? a = Ct(o.source) : a = new URL(
      o.source,
      this.map.consumer().sourceRoot || Ct(this.map.mapFile)
    );
    let u = {
      column: o.column,
      endColumn: l && l.column,
...
var lr = Yt;
Yt.default = Yt;
Cr && Cr.registerInput && Cr.registerInput(Yt);
let { SourceMapConsumer: Ln, SourceMapGenerator: Lt } = ie, { dirname: Tt, relative: Tn, resolve: _n, sep: Fn } = ie, { pathToFileURL: di } = ie, Yu = lr, Zu = !!(Ln && Lt), Ju = !!(Tt && _n && Tn && Fn), Xu = class {
  constructor(e, t, r, i) {
    this.stringify = e, this.mapOpts = r.map || {}, this.root = t, this.opts = r, this.css = i, this.originalCSS = i, this.usesFileUrls = !this.mapOpts.from && this.mapOpts.absolute, this.memoizedFileURLs = /* @__PURE__ */ new Map(), this.memoizedPaths = /* @__PURE__ */ new Map(), this.memoizedURLs = /* @__PURE__ */ new Map();
  }
  addAnnotation() {
...
`), this.css += t + "/*# sourceMappingURL=" + e + " */";
  ...
  applyPrevMaps() {
    for (let e of this.previous()) {
      let t = this.toUrl(this.path(e.file)), r = e.root || Tt(e.file), i;
      this.mapOpts.sourcesContent === !1 ? (i = new Ln(e.text), i.sourcesContent && (i.sourcesContent = null)) : i = e.consumer(), this.map.applySourceMap(i, t, this.toUrl(this.path(r)));
    }
  }
  clearAnnotation() {
    if (this.mapOpts.annotation !== !1)
  ...
  generate() {
    if (this.clearAnnotation(), Ju && Zu && this.isMap())
      return this.generateMap();
    {
      let e = "";
      return this.stringify(this.root, (t) => {
...
`), t = l.length - o) : t += l.length, a && u !== "start") {
  ...
  path(e) {
    ...
    typeof this.mapOpts.annotation == "string" && (r = Tt(_n(r, this.mapOpts.annotation)));
    let i = Tn(r, e);
    return this.memoizedPaths.set(e, i), i;
  }
  previous() {
    if (!this.previousMaps)
      if (this.previousMaps = [], this.root)
        ...
        let e = new Yu(this.originalCSS, this.opts);
        e.map && this.previousMaps.push(e.map);
      }
    return this.previousMaps;
  }
...
var ur = qr;
qr.default = qr;
let { isClean: Bn, my: zn } = it, Wn = ar, Gn = ur, Qu = or, jn, vs, Is, Vn;
function Hn(s) {
  return s.map((e) => (e.nodes && (e.nodes = Hn(e.nodes)), delete e.source, e));
}
function Yn(s) {
  if (s[Bn] = !1, s.proxyOf.nodes)
    for (let e of s.proxyOf.nodes)
      Yn(e);
}
let he = class Zn extends Qu {
  append(...e) {
    for (let t of e) {
      let r = this.normalize(t, this.last);
      for (let i of r) this.proxyOf.nodes.push(i);
  ...
  normalize(e, t) {
    if (typeof e == "string")
      ...
      if (typeof e.value > "u")
        throw new Error("Value field is missed in node creation");
      typeof e.value != "string" && (e.value = String(e.value)), e = [new Wn(e)];
    } else if (e.selector)
      e = [new vs(e)];
    else if (e.name)
      e = [new Is(e)];
      ...
      throw new Error("Unknown node type in node creation");
    return e.map((i) => (i[zn] || Zn.rebuild(i), i = i.proxyOf, i.parent && i.parent.removeChild(i), i[Bn] && Yn(i), typeof i.raws.before > "u" && t && typeof t.raws.before < "u" && (i.raws.before = t.raws.before.replace(/\S/g, "")), i.parent = this.proxyOf, i));
  }
  prepend(...e) {
    e = e.reverse();
    for (let t of e) {
...
he.default = he;
he.rebuild = (s) => {
  s.type === "atrule" ? Object.setPrototypeOf(s, Is.prototype) : s.type === "rule" ? Object.setPrototypeOf(s, vs.prototype) : s.type === "decl" ? Object.setPrototypeOf(s, Wn.prototype) : s.type === "comment" ? Object.setPrototypeOf(s, Gn.prototype) : s.type === "root" && Object.setPrototypeOf(s, Vn.prototype), s[zn] = !0, s.nodes && s.nodes.forEach((e) => {
    he.rebuild(e);
  });
};
let qu = Ce, Jn, Xn, Ke = class extends qu {
  constructor(e) {
    super({ type: "document", ...e }), this.nodes || (this.nodes = []);
  }
  toResult(e = {}) {
    return new Jn(new Xn(), this, e).stringify();
  }
};
...
let mi = {};
var Kn = function(e) {
  mi[e] || (mi[e] = !0, typeof console < "u" && console.warn && console.warn(e));
};
let es = class {
  constructor(e, t = {}) {
    if (this.type = "warning", this.text = e, t.node && t.node.source) {
...
var Rs = ts;
ts.default = ts;
const Ir = 39, gi = 34, vt = 92, yi = 47, It = 10, ze = 32, xt = 12, Rt = 9, Ot = 13, tc = 91, rc = 93, sc = 40, ic = 41, nc = 123, oc = 125, ac = 59, lc = 42, uc = 58, cc = 64, At = /[\t\n\f\r "#'()/;[\\\]{}]/g, Mt = /[\t\n\f\r !"#'():;@[\\\]{}]|\/(?=\*)/g, hc = /.[\r\n"'(/\\]/, wi = /[\da-f]/i;
var fc = function(e, t = {}) {
  let r = e.css.valueOf(), i = t.ignoreErrors, n, o, l, a, u, c, h, d, g, m, p = r.length, f = 0, S = [], b = [];
  function y() {
    return f;
  ...
  function k(T) {
    ...
    switch (n = r.charCodeAt(f), n) {
      ...
      case xt: {
        ...
        do
          o += 1, n = r.charCodeAt(o);
        while (n === ze || n === It || n === Rt || n === Ot || n === xt);
        m = ["space", r.slice(f, o)], f = o - 1;
        break;
      }
      case tc:
      ...
      case sc: {
        if (d = S.length ? S.pop()[1] : "", g = r.charCodeAt(f + 1), d === "url" && g !== Ir && g !== gi && g !== ze && g !== It && g !== Rt && g !== xt && g !== Ot) {
          o = f;
          do {
            if (c = !1, o = r.indexOf(")", o + 1), o === -1)
              if (i || W) {
                ...
                C("bracket");
            for (h = o; r.charCodeAt(h - 1) === vt; )
              h -= 1, c = !c;
          } while (c);
          m = ["brackets", r.slice(f, o + 1), f, o], f = o;
        } else
          o = r.indexOf(")", f + 1), a = r.slice(f, o + 1), o === -1 || hc.test(a) ? m = ["(", "(", f] : (m = ["brackets", a, f, o], f = o);
        break;
      }
      case Ir:
      case gi: {
      ...
      case cc: {
        At.lastIndex = f + 1, At.test(r), At.lastIndex === 0 ? o = r.length - 1 : o = At.lastIndex - 2, m = ["at-word", r.slice(f, o + 1), f, o], f = o;
        break;
      }
      case vt: {
        for (o = f, u = !0; r.charCodeAt(o + 1) === vt; )
          o += 1, u = !u;
        if (n = r.charCodeAt(o + 1), u && n !== yi && n !== ze && n !== It && n !== Rt && n !== Ot && n !== xt && (o += 1, wi.test(r.charAt(o)))) {
          for (; wi.test(r.charAt(o + 1)); )
            o += 1;
      ...
      default: {
        n === yi && r.charCodeAt(f + 1) === lc ? (o = r.indexOf("*/", f + 2) + 1, o === 0 && (i || W ? o = r.length : C("comment")), m = ["comment", r.slice(f, o + 1), f, o], f = o) : (Mt.lastIndex = f + 1, Mt.test(r), Mt.lastIndex === 0 ? o = r.length - 1 : o = Mt.lastIndex - 2, m = ["word", r.slice(f, o + 1), f, o], S.push(m), f = o);
        break;
      }
    }
    return f++, m;
...
var Os = Zt;
Zt.default = Zt;
qn.registerAtRule(Zt);
let eo = Ce, to, ro, Pe = class extends eo {
  constructor(e) {
    super(e), this.type = "root", this.nodes || (this.nodes = []);
  }
  normalize(e, t, r) {
  ...
  toResult(e = {}) {
    return new to(new ro(), this, e).stringify();
  }
};
Pe.registerLazyResult = (s) => {
  to = s;
};
Pe.registerProcessor = (s) => {
  ro = s;
};
var nt = Pe;
Pe.default = Pe;
...
var so = Qe;
Qe.default = Qe;
let io = Ce, pc = so, Jt = class extends io {
  constructor(e) {
    super(e), this.type = "rule", this.nodes || (this.nodes = []);
  }
  get selectors() {
...
Jt.default = Jt;
io.registerRule(Jt);
let dc = ar, mc = fc, gc = ur, yc = Os, wc = nt, Si = As;
const bi = {
  empty: !0,
  space: !0
};
...
let bc = class {
  constructor(e) {
    this.input = e, this.root = new wc(), this.current = this.root, this.spaces = "", this.semicolon = !1, this.createTokenizer(), this.root.source = { input: e, start: { column: 1, line: 1, offset: 0 } };
  }
  atrule(e) {
    let t = new yc();
    t.name = e[1].slice(1), t.name === "" && this.unnamedAtrule(t, e), this.init(t, e[2]);
  ...
  raw(e, t, r, i) {
    let n, o, l = r.length, a = "", u = !0, c, h;
    for (let d = 0; d < l; d += 1)
      n = r[d], o = n[0], o === "space" && d === l - 1 && !i ? u = !1 : o === "comment" ? (h = r[d - 1] ? r[d - 1][0] : "empty", c = r[d + 1] ? r[d + 1][0] : "empty", !bi[h] && !bi[c] ? a.slice(-1) === "," ? u = !1 : a += n[1] : u = !1) : a += n[1];
    if (!u) {
      let d = r.reduce((g, m) => g + m[1], "");
      e.raws[t] = { raw: d, value: a };
    }
...
var Cc = bc;
let vc = Ce, Ic = Cc, xc = lr;
function Xt(s, e) {
  let t = new xc(s, e), r = new Ic(t);
  try {
    r.parse();
  } catch (i) {
    throw process.env.NODE_ENV !== "production" && i.name === "CssSyntaxError" && e && e.from && (/\.scss$/i.test(e.from) ? i.message += `
...
Xt.default = Xt;
vc.registerParse(Xt);
let { isClean: le, my: Rc } = it, Oc = Un, Ac = nr, Mc = Ce, Ec = xs, $c = Kn, Ci = Rs, Nc = Ms, kc = nt;
const Pc = {
  atrule: "AtRule",
  comment: "Comment",
  decl: "Declaration",
...
function vi(s) {
  let e;
  return s.type === "document" ? e = ["Document", De, "DocumentExit"] : s.type === "root" ? e = ["Root", De, "RootExit"] : e = no(s), {
    eventIndex: 0,
    events: e,
    iterator: 0,
    node: s,
...
function rs(s) {
  return s[le] = !1, s.nodes && s.nodes.forEach((e) => rs(e)), s;
}
let ss = {}, Le = class oo {
  constructor(e, t, r) {
    this.stringified = !1, this.processed = !1;
    ...
    if (typeof t == "object" && t !== null && (t.type === "root" || t.type === "document"))
      i = rs(t);
    else if (t instanceof oo || t instanceof Ci)
      i = rs(t.root), t.map && (typeof r.map > "u" && (r.map = {}), r.map.inline || (r.map.inline = !1), r.map.prev = t.map);
    else {
      let n = Nc;
      r.syntax && (n = r.syntax.parse), r.parser && (n = r.parser), n.parse && (n = n.parse);
      try {
    ...
    this.result = new Ci(e, i, r), this.helpers = { ...ss, postcss: ss, result: this.result }, this.plugins = this.processor.plugins.map((n) => typeof n == "object" && n.prepare ? { ...n, ...n.prepare(this.result) } : n);
  }
  async() {
    return this.error ? Promise.reject(this.error) : this.processed ? Promise.resolve(this.result) : (this.processing || (this.processing = this.runAsync()), this.processing);
  }
  ...
  stringify() {
    ...
    if (this.stringified) return this.result;
    this.stringified = !0, this.sync();
    let e = this.result.opts, t = Ac;
    e.syntax && (t = e.syntax.stringify), e.stringifier && (t = e.stringifier), t.stringify && (t = t.stringify);
    let i = new Oc(t, this.result.root, this.result.opts).generate();
    return this.result.css = i[0], this.result.map = i[1], this.result;
  }
  sync() {
    if (this.error) throw this.error;
...
Le.registerPostcss = (s) => {
  ss = s;
};
var ao = Le;
Le.default = Le;
kc.registerLazyResult(Le);
Ec.registerLazyResult(Le);
let Tc = Un, _c = nr, Fc = Kn, Uc = Ms;
const Bc = Rs;
let is = class {
  constructor(e, t, r) {
    t = t.toString(), this.stringified = !1, this._processor = e, this._css = t, this._opts = r, this._map = void 0;
    let i, n = _c;
    this.result = new Bc(this._processor, i, this._opts), this.result.css = t;
    let o = this;
    Object.defineProperty(this.result, "root", {
      get() {
        return o.root;
  ...
  then(e, t) {
    return process.env.NODE_ENV !== "production" && ("from" in this._opts || Fc(
      "Without `from` option PostCSS could generate wrong source map and will not find Browserslist config. Set it to CSS file path or to `undefined` to prevent this warning."
    )), this.async().then(e, t);
  }
  toString() {
...
var zc = is;
is.default = is;
let Wc = zc, Gc = ao, jc = xs, Vc = nt, qe = class {
  constructor(e = []) {
    this.version = "8.4.38", this.plugins = this.normalize(e);
  }
  normalize(e) {
  ...
  process(e, t = {}) {
    return !this.plugins.length && !t.parser && !t.stringifier && !t.syntax ? new Wc(this, e, t) : new Gc(this, e, t);
  }
  use(e) {
    return this.plugins = this.plugins.concat(this.normalize([e])), this;
  }
...
var Hc = qe;
qe.default = qe;
Vc.registerProcessor(qe);
jc.registerProcessor(qe);
let Yc = ar, Zc = Dn, Jc = ur, Xc = Os, Kc = lr, Qc = nt, qc = As;
function et(s, e) {
  if (Array.isArray(s)) return s.map((i) => et(i));
  let { inputs: t, ...r } = s;
  if (t) {
    e = [];
    for (let i of t) {
      let n = { ...i, __proto__: Kc.prototype };
      n.map && (n.map = {
        ...n.map,
        __proto__: Zc.prototype
      }), e.push(n);
    }
  }
  if (r.nodes && (r.nodes = s.nodes.map((i) => et(i, e))), r.source) {
    let { inputId: i, ...n } = r.source;
    r.source = n, i != null && (r.source.input = e[i]);
  }
  if (r.type === "root")
...
var eh = et;
et.default = et;
let th = Cs, lo = ar, rh = ao, sh = Ce, Es = Hc, ih = nr, nh = eh, uo = xs, oh = Qn, co = ur, ho = Os, ah = Rs, lh = lr, uh = Ms, ch = so, fo = As, po = nt, hh = or;
function E(...s) {
  return s.length === 1 && Array.isArray(s[0]) && (s = s[0]), new Es(s);
}
...
https://www.w3ctech.com/topic/2226`
    ...
    let l = t(...o);
    return l.postcssPlugin = e, l.postcssVersion = new Es().version, l;
  }
  let n;
  return Object.defineProperty(i, "postcss", {
    get() {
...
E.fromJSON = nh;
E.list = ch;
E.comment = (s) => new co(s);
E.atRule = (s) => new ho(s);
E.decl = (s) => new lo(s);
E.rule = (s) => new fo(s);
E.root = (s) => new po(s);
E.document = (s) => new uo(s);
E.CssSyntaxError = th;
E.Declaration = lo;
E.Container = sh;
E.Processor = Es;
...
E.Root = po;
E.Node = hh;
rh.registerPostcss(E);
var fh = E;
E.default = E;
const F = /* @__PURE__ */ Iu(fh);
F.stringify;
F.fromJSON;
F.plugin;
F.parse;
...
const Ii = {
  ...
  Element: [],
  MutationObserver: ["constructor"]
}, Et = {}, ph = () => !!globalThis.Zone;
function Ns(s) {
  if (Et[s])
    return Et[s];
  const e = globalThis[s], t = e.prototype, r = s in Ii ? Ii[s] : void 0, i = !!(r && // @ts-expect-error 2345
  r.every(
    (l) => {
      var a, u;
      return !!((u = (a = Object.getOwnPropertyDescriptor(t, l)) == null ? void 0 : a.get) != null && u.toString().includes("[native code]"));
    }
  )), n = s in xi ? xi[s] : void 0, o = !!(n && n.every(
    // @ts-expect-error 2345
    (l) => {
      var a;
      return typeof t[l] == "function" && ((a = t[l]) == null ? void 0 : a.toString().includes("[native code]"));
  ...
  if (i && o && !ph())
    return Et[s] = e.prototype, e.prototype;
  try {
    const l = document.createElement("iframe");
    document.body.appendChild(l);
    const a = l.contentWindow;
    if (!a) return e.prototype;
    const u = a[s].prototype;
    return document.body.removeChild(l), u ? Et[s] = u : t;
  } catch {
    return t;
  }
}
...
function pe(s, e, t) {
  ...
  const n = Ns(s), o = (r = Object.getOwnPropertyDescriptor(
    n,
    t
  )) == null ? void 0 : r.get;
  return o ? (xr[i] = o, o.call(e)) : e[t];
}
const Rr = {};
function mo(s, e, t) {
  const r = `${s}.${String(t)}`;
  ...
  const n = Ns(s)[t];
  return typeof n != "function" ? e[t] : (Rr[r] = n, n.bind(e));
}
function dh(s) {
  return pe("Node", s, "ownerDocument");
}
function mh(s) {
...
function Sh(s, e) {
  return mo("Node", s, "contains")(e);
}
function bh(s) {
  return mo("Node", s, "getRootNode")();
}
function Ch(s) {
...
function go() {
  return Ns("MutationObserver").constructor;
}
function ve(s, e, t) {
  try {
    if (!(e in s))
...
typeof window < "u" && window.Proxy && window.Reflect && (Ri = new Proxy(Ri, {
  get(s, e, t) {
...
let Kt = Date.now;
/* @__PURE__ */ /[1-9][0-9]{12}/.test(Date.now().toString()) || (Kt = () => (/* @__PURE__ */ new Date()).getTime());
function yo(s) {
  var e, t, r, i;
  const n = s.document;
  return {
...
function Or(s, e, t) {
  return s.tagName === "TITLE" && t.headTitleMutations ? !0 : e.getId(s) === He;
}
function Co(s, e) {
  if (Ge(s))
    return !1;
  ...
  return r && r.nodeType === s.DOCUMENT_NODE ? !1 : r ? Co(r, e) : !0;
}
function ns(s) {
  return !!s.changedTouches;
}
function Ah(s = window) {
...
function os(s) {
  return s ? s instanceof $s && "shadowRoot" in s ? !!s.shadowRoot : !!v.shadowRoot(s) : !1;
}
class Mh {
  constructor() {
...
function Ro(s) {
  const e = v.ownerDocument(s);
  return e ? v.contains(e, s) || $h(s) : !1;
}
var R = /* @__PURE__ */ ((s) => (s[s.DomContentLoaded = 0] = "DomContentLoaded", s[s.Load = 1] = "Load", s[s.FullSnapshot = 2] = "FullSnapshot", s[s.IncrementalSnapshot = 3] = "IncrementalSnapshot", s[s.Meta = 4] = "Meta", s[s.Custom = 5] = "Custom", s[s.Plugin = 6] = "Plugin", s))(R || {}), I = /* @__PURE__ */ ((s) => (s[s.Mutation = 0] = "Mutation", s[s.MouseMove = 1] = "MouseMove", s[s.MouseInteraction = 2] = "MouseInteraction", s[s.Scroll = 3] = "Scroll", s[s.ViewportResize = 4] = "ViewportResize", s[s.Input = 5] = "Input", s[s.TouchMove = 6] = "TouchMove", s[s.MediaInteraction = 7] = "MediaInteraction", s[s.StyleSheetRule = 8] = "StyleSheetRule", s[s.CanvasMutation = 9] = "CanvasMutation", s[s.Font = 10] = "Font", s[s.Log = 11] = "Log", s[s.Drag = 12] = "Drag", s[s.StyleDeclaration = 13] = "StyleDeclaration", s[s.Selection = 14] = "Selection", s[s.AdoptedStyleSheet = 15] = "AdoptedStyleSheet", s[s.CustomElement = 16] = "CustomElement", s))(I || {}), X = /* @__PURE__ */ ((s) => (s[s.MouseUp = 0] = "MouseUp", s[s.MouseDown = 1] = "MouseDown", s[s.Click = 2] = "Click", s[s.ContextMenu = 3] = "ContextMenu", s[s.DblClick = 4] = "DblClick", s[s.Focus = 5] = "Focus", s[s.Blur = 6] = "Blur", s[s.TouchStart = 7] = "TouchStart", s[s.TouchMove_Departed = 8] = "TouchMove_Departed", s[s.TouchEnd = 9] = "TouchEnd", s[s.TouchCancel = 10] = "TouchCancel", s))(X || {}), ue = /* @__PURE__ */ ((s) => (s[s.Mouse = 0] = "Mouse", s[s.Pen = 1] = "Pen", s[s.Touch = 2] = "Touch", s))(ue || {}), Te = /* @__PURE__ */ ((s) => (s[s["2D"] = 0] = "2D", s[s.WebGL = 1] = "WebGL", s[s.WebGL2 = 2] = "WebGL2", s))(Te || {}), Oe = /* @__PURE__ */ ((s) => (s[s.Play = 0] = "Play", s[s.Pause = 1] = "Pause", s[s.Seeked = 2] = "Seeked", s[s.VolumeChange = 3] = "VolumeChange", s[s.RateChange = 4] = "RateChange", s))(Oe || {}), Oo = /* @__PURE__ */ ((s) => (s[s.Document = 0] = "Document", s[s.DocumentType = 1] = "DocumentType", s[s.Element = 2] = "Element", s[s.Text = 3] = "Text", s[s.CDATA = 4] = "CDATA", s[s.Comment = 5] = "Comment", s))(Oo || {});
function Oi(s) {
  return "__ln" in s;
}
class Nh {
  ...
  addNode(e) {
    ...
    if (e.__ln = t, e.previousSibling && Oi(e.previousSibling)) {
    ...
    } else if (e.nextSibling && Oi(e.nextSibling) && e.nextSibling.__ln.previous) {
  ...
  constructor() {
    w(this, "frozen", !1), w(this, "locked", !1), w(this, "texts", []), w(this, "attributes", []), w(this, "attributeMap", /* @__PURE__ */ new WeakMap()), w(this, "removes", []), w(this, "mapRemoves", []), w(this, "movedMap", {}), w(this, "addedSet", /* @__PURE__ */ new Set()), w(this, "movedSet", /* @__PURE__ */ new Set()), w(this, "droppedSet", /* @__PURE__ */ new Set()), w(this, "removesSubTreeCache", /* @__PURE__ */ new Set()), w(this, "mutationCb"), w(this, "blockClass"), w(this, "blockSelector"), w(this, "maskTextClass"), w(this, "maskTextSelector"), w(this, "inlineStylesheet"), w(this, "maskInputOptions"), w(this, "maskTextFn"), w(this, "maskInputFn"), w(this, "keepIframeSrcFn"), w(this, "recordCanvas"), w(this, "inlineImages"), w(this, "slimDOMOptions"), w(this, "dataURLOptions"), w(this, "doc"), w(this, "mirror"), w(this, "iframeManager"), w(this, "stylesheetManager"), w(this, "shadowDomManager"), w(this, "canvasManager"), w(this, "processedNodeManager"), w(this, "unattachedDoc"), w(this, "processMutations", (e) => {
      ...
      if (this.frozen || this.locked)
        return;
      const e = [], t = /* @__PURE__ */ new Set(), r = new Nh(), i = (a) => {
        let u = a, c = He;
        for (; c === He; )
        ...
        const h = Ge(u) ? this.mirror.getId(xo(a)) : this.mirror.getId(u), d = i(a);
        if (h === -1 || d === -1)
          return r.addNode(a);
        const g = Me(a, {
          doc: this.doc,
          ...
          onSerialize: (m) => {
            vo(m, this.mirror) && this.iframeManager.addIframe(m), Io(m, this.mirror) && this.stylesheetManager.trackLinkElement(
              m
            ), os(a) && this.shadowDomManager.addShadowRoot(v.shadowRoot(a), this.doc);
          },
          onIframeLoad: (m, p) => {
            this.iframeManager.attachIframe(m, p), this.shadowDomManager.observeAttachShadow(m);
          },
          onStylesheetLoad: (m, p) => {
            this.stylesheetManager.attachLinkElement(m, p);
          },
          cssCaptured: c
        });
        g && (e.push({
      ...
      for (const a of this.movedSet)
        Mi(this.removesSubTreeCache, a, this.mirror) && !this.movedSet.has(v.parentNode(a)) || n(a);
      for (const a of this.addedSet)
        !Ei(this.droppedSet, a) && !Mi(this.removesSubTreeCache, a, this.mirror) || Ei(this.movedSet, a) ? n(a) : this.droppedSet.add(a);
      let o = null;
      for (; r.length; ) {
        let a = null;
        if (o) {
          ...
          for (; u; ) {
            ...
            if (u = u.previous, c) {
              ...
              if (h !== -1) {
                ...
                const g = c.value, m = v.parentNode(g);
        ...
        switch (e.type) {
          case "characterData": {
            ...
            !J(e.target, this.blockClass, this.blockSelector, !1) && t !== e.oldValue && this.texts.push({
              value: Vi(
                ...
                !0
                // checkAncestors
              ) && t ? this.maskTextFn ? this.maskTextFn(t, bo(e.target)) : t.replace(/[\S]/g, "*") : t,
              node: e.target
            });
            break;
          }
          case "attributes": {
            ...
            if (n || (n = {
              ...
              styleDiff: {},
              _unchangedStyles: {}
            }, this.attributes.push(n), this.attributeMap.set(e.target, n)), r === "type" && t.tagName === "INPUT" && (e.oldValue || "").toLowerCase() === "password" && t.setAttribute("data-rr-is-password", "true"), !ji(t.tagName, r))
              if (n.attributes[r] = Gi(
                this.doc,
                Se(t.tagName),
                Se(r),
                i
          ...
          case "childList": {
            ...
            e.addedNodes.forEach((t) => this.genAdds(t, e.target)), e.removedNodes.forEach((t) => {
              const r = this.mirror.getId(t), i = Ge(e.target) ? this.mirror.getId(v.host(e.target)) : this.mirror.getId(e.target);
              J(e.target, this.blockClass, this.blockSelector, !1) || Or(t, this.mirror, this.slimDOMOptions) || !Oh(t, this.mirror) || (this.addedSet.has(t) ? (as(this.addedSet, t), this.droppedSet.add(t)) : this.addedSet.has(e.target) && r === -1 || Co(e.target, this.mirror) || (this.movedSet.has(t) && this.movedMap[Ai(r, i)] ? as(this.movedSet, t) : (this.removes.push({
                parentId: i,
                id: r,
                isShadow: Ge(e.target) && je(e.target) ? !0 : void 0
              }), Ph(t, this.removesSubTreeCache))), this.mapRemoves.push(t));
            });
            break;
          }
        }
      ...
      if (!this.processedNodeManager.inOtherBuffer(e, this) && !(this.addedSet.has(e) || this.movedSet.has(e))) {
        if (this.mirror.hasNode(e)) {
          ...
          this.movedSet.add(e);
          let r = null;
          t && this.mirror.hasNode(t) && (r = this.mirror.getId(t)), r && r !== -1 && (this.movedMap[Ai(this.mirror.getId(e), r)] = !0);
        } else
          this.addedSet.add(e), this.droppedSet.delete(e);
        J(e, this.blockClass, this.blockSelector, !1) || (v.childNodes(e).forEach((r) => this.genAdds(r)), os(e) && v.childNodes(v.shadowRoot(e)).forEach((r) => {
...
function as(s, e) {
  s.delete(e), v.childNodes(e).forEach((t) => as(s, t));
}
function Ph(s, e) {
  const t = [s];
  for (; t.length; ) {
...
function _h({
  ...
  const a = tt(
    ...
    tt(
      x((h) => {
        const d = ot(h), { clientX: g, clientY: m } = ns(h) ? h.changedTouches[0] : h;
        l || (l = Kt()), o.push({
          x: g,
          y: m,
          id: r.getId(d),
...
function Fh({
  ...
  const u = (c) => (h) => {
    ...
    if ("pointerType" in h) {
      ...
      g === ue.Touch ? X[c] === X.MouseDown ? m = "TouchStart" : X[c] === X.MouseUp && (m = "TouchEnd") : ue.Pen;
    } else ns(h) && (g = ue.Touch);
    g !== null ? (a = g, (m.startsWith("Touch") && g === ue.Touch || m.startsWith("Mouse") && g === ue.Mouse) && (g = null)) : X[c] === X.Click && (g = a, a = null);
    const p = ns(h) ? h.changedTouches[0] : h;
    if (!p)
      return;
...
function Uh({ viewportResizeCb: s }, { win: e }) {
  let t = -1, r = -1;
  const i = x(
    tt(
      x(() => {
...
const Bh = ["INPUT", "TEXTAREA", "SELECT"], $i = /* @__PURE__ */ new WeakMap();
function zh({
  inputCb: s,
  doc: e,
  mirror: t,
  ...
  function h(b) {
    ...
    if (y && $ === "OPTION" && (y = v.parentElement(y)), !y || !$ || Bh.indexOf($) < 0 || J(y, r, i, !0) || y.classList.contains(n) || o && y.matches(o))
      return;
    let k = y.value, G = !1;
    const T = Bt(y) || "";
    T === "radio" || T === "checkbox" ? G = y.checked : (l[$.toLowerCase()] || l[T]) && (k = Ut({
      element: y,
      maskInputOptions: l,
      tagName: $,
      type: T,
      ...
      y,
      c ? { text: k, isChecked: G, userTriggered: C } : { text: k, isChecked: G }
    );
    const W = y.name;
    T === "radio" && W && G && e.querySelectorAll(`input[type="radio"][name="${W}"]`).forEach((H) => {
      if (H !== y) {
        const Q = H.value;
        d(
          H,
          c ? { text: Q, isChecked: !G, userTriggered: !1 } : { text: Q, isChecked: !G }
        );
      }
    });
  }
  ...
  const m = (u.input === "last" ? ["change"] : ["input", "change"]).map(
    (b) => Z(b, x(h), e)
  ), p = e.defaultView;
  if (!p)
    return () => {
...
function Qt(s) {
  const e = [];
  function t(r, i) {
    if ($t("CSSGroupingRule") && r.parentRule instanceof CSSGroupingRule || $t("CSSMediaRule") && r.parentRule instanceof CSSMediaRule || $t("CSSSupportsRule") && r.parentRule instanceof CSSSupportsRule || $t("CSSConditionRule") && r.parentRule instanceof CSSConditionRule) {
      const o = Array.from(
...
function Wh({ styleSheetRuleCb: s, mirror: e, stylesheetManager: t }, { win: r }) {
  ...
  r.CSSStyleSheet.prototype.insertRule = new Proxy(i, {
    ...
    const g = `${c} { ${h} }`;
    return r.CSSStyleSheet.prototype.insertRule.apply(this, [g, d]);
  };
  const n = r.CSSStyleSheet.prototype.deleteRule;
  r.CSSStyleSheet.prototype.deleteRule = new Proxy(n, {
    apply: x(
      (c, h, d) => {
        const [g] = d, { id: m, styleId: p } = de(
          h,
          e,
          t.styleMirror
        );
        return (m && m !== -1 || p && p !== -1) && s({
          id: m,
          styleId: p,
          removes: [{ index: g }]
        }), c.apply(h, d);
  ...
  const a = {};
  Nt("CSSGroupingRule") ? a.CSSGroupingRule = r.CSSGroupingRule : (Nt("CSSMediaRule") && (a.CSSMediaRule = r.CSSMediaRule), Nt("CSSConditionRule") && (a.CSSConditionRule = r.CSSConditionRule), Nt("CSSSupportsRule") && (a.CSSSupportsRule = r.CSSSupportsRule));
  const u = {};
  ...
  i.CSSStyleDeclaration.prototype.setProperty = new Proxy(n, {
    apply: x(
      (l, a, u) => {
        ...
        const [h, d, g] = u;
        if (t.has(h))
          return n.apply(a, [h, d, g]);
        const { id: m, styleId: p } = de(
  ...
  return i.CSSStyleDeclaration.prototype.removeProperty = new Proxy(o, {
    apply: x(
      (l, a, u) => {
        ...
        if (t.has(h))
          return o.apply(a, [h]);
        const { id: d, styleId: g } = de(
          (c = a.parentRule) == null ? void 0 : c.parentStyleSheet,
          e,
          r.styleMirror
        );
        return (d && d !== -1 || g && g !== -1) && s({
          id: d,
          styleId: g,
          remove: {
            property: h
  ...
  const o = x(
    (a) => tt(
      x((u) => {
        ...
        if (!c || J(c, e, t, !0))
          return;
        const { currentTime: h, volume: d, muted: g, playbackRate: m, loop: p } = c;
        s({
          type: a,
          id: r.getId(c),
          currentTime: h,
    ...
    Z("play", o(Oe.Play), n),
    Z("pause", o(Oe.Pause), n),
    Z("seeked", o(Oe.Seeked), n),
    Z("volumechange", o(Oe.VolumeChange), n),
    Z("ratechange", o(Oe.RateChange), n)
  ];
  return x(() => {
    l.forEach((a) => a());
  });
}
function Vh({ fontCb: s, doc: e }) {
...
function Hh(s) {
  ...
  const l = x(() => {
    ...
    for (let h = 0; h < c; h++) {
      const d = a.getRangeAt(h), { startContainer: g, startOffset: m, endContainer: p, endOffset: f } = d;
      J(g, r, i, !0) || J(p, r, i, !0) || u.push({
        start: t.getId(g),
        startOffset: m,
        end: t.getId(p),
        endOffset: f
...
function Zh(s, e) {
  ...
  s.mutationCb = (...p) => {
    ...
    e.selection && e.selection(...p), g(...p);
  }, s.customElementCb = (...p) => {
    e.customElement && e.customElement(...p), m(...p);
  };
}
function Jh(s, e = {}) {
  ...
  Zh(s, e);
  let r;
  s.recordDOM && (r = Mo(s, s.doc));
  const i = _h(s), n = Fh(s), o = Eo(s), l = Uh(s, {
    win: t
  }), a = zh(s), u = jh(s);
  let c = () => {
  }, h = () => {
  ...
  s.recordDOM && (c = Wh(s, { win: t }), h = $o(s, s.doc), d = Gh(s, {
    win: t
  }), s.collectFonts && (g = Vh(s)));
  const m = Hh(s), p = Yh(s), f = [];
  for (const S of s.plugins)
    f.push(
      S.observer(S.callback, t, S.options)
    );
  return x(() => {
    we.forEach((S) => S.reset()), r == null || r.disconnect(), i(), n(), o(), l(), a(), u(), c(), h(), d(), g(), m(), p(), f.forEach((S) => S());
  });
}
function $t(s) {
...
class Xh {
  ...
  patchRootIdOnNode(e, t) {
    e.type !== Oo.Document && !e.rootId && (e.rootId = t), "childNodes" in e && e.childNodes.forEach((r) => {
...
var Ee = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", Qh = typeof Uint8Array > "u" ? [] : new Uint8Array(256);
for (var kt = 0; kt < Ee.length; kt++)
  Qh[Ee.charCodeAt(kt)] = kt;
var qh = function(s) {
  var e = new Uint8Array(s), t, r = e.length, i = "";
  for (t = 0; t < r; t += 3)
    i += Ee[e[t] >> 2], i += Ee[(e[t] & 3) << 4 | e[t + 1] >> 4], i += Ee[(e[t + 1] & 15) << 2 | e[t + 2] >> 6], i += Ee[e[t + 2] & 63];
  return r % 3 === 2 ? i = i.substring(0, i.length - 1) + "=" : r % 3 === 1 && (i = i.substring(0, i.length - 2) + "=="), i;
};
const ki = /* @__PURE__ */ new Map();
function ef(s, e) {
  let t = ki.get(s);
  return t || (t = /* @__PURE__ */ new Map(), ki.set(s, t)), t.has(e) || t.set(e, []), t.get(e);
}
const No = (s, e, t) => {
  if (!s || !(Po(s, e) || typeof s == "object"))
    return;
  const r = s.constructor.name, i = ef(t, r);
  let n = i.indexOf(s);
  return n === -1 && (n = i.length, i.push(s)), n;
};
function _t(s, e, t) {
  if (s instanceof Array)
    return s.map((r) => _t(r, e, t));
  if (s === null)
    return s;
  ...
  if (
    ...
    const r = s.constructor.name, i = qh(s);
    return {
      rr_type: r,
      base64: i
    };
    ...
    if (s instanceof HTMLImageElement) {
      ...
      if (s instanceof ImageData)
        return {
          rr_type: s.constructor.name,
          args: [_t(s.data, e, t), s.width, s.height]
        };
      if (Po(s, e) || typeof s == "object") {
        const r = s.constructor.name, i = No(s, e, t);
        return {
          rr_type: r,
          index: i
        };
...
const ko = (s, e, t) => s.map((r) => _t(r, e, t)), Po = (s, e) => !![
  "WebGLActiveInfo",
  "WebGLBuffer",
  "WebGLFramebuffer",
  "WebGLProgram",
        ...
        const u = ve(
          ...
          function(c) {
            return function(...h) {
              ...
              if (No(d, n, this), "tagName" in this.canvas && !J(this.canvas, r, i, !0)) {
                const g = ko(h, n, this), m = {
                  type: e,
                  property: a,
                  args: g
                };
...
function of(s) {
  ...
  try {
    ...
    return new Worker(
      "data:text/javascript;base64," + Do,
      {
        name: s == null ? void 0 : s.name
      }
    );
...
class af {
  ...
  initCanvasFPSObserver(e, t, r, i, n) {
    const o = Pi(
      ...
      i,
      !0
    ), l = /* @__PURE__ */ new Map(), a = new of();
    a.onmessage = (m) => {
      const { id: p } = m.data;
      if (l.set(p, !1), !("base64" in m.data)) return;
      const { base64: f, type: S, width: b, height: y } = m.data;
      this.mutationCb({
        id: p,
        type: Te["2D"],
        commands: [
...
class lf {
  constructor(e) {
    w(this, "trackedLinkElements", /* @__PURE__ */ new WeakSet()), w(this, "mutationCb"), w(this, "adoptedStyleSheetCb"), w(this, "styleMirror", new Mh()), this.mutationCb = e.mutationCb, this.adoptedStyleSheetCb = e.adoptedStyleSheetCb;
  }
...
try {
  if (Array.from([1], (s) => s * 2)[0] !== 2) {
    ...
    document.body.appendChild(s), Array.from = ((Ts = s.contentWindow) == null ? void 0 : Ts.Array.from) || Array.from, document.body.removeChild(s);
  }
} catch (s) {
...
function Ie(s = {}) {
  const {
    ...
    recordAfter: T = s.recordAfter === "DOMContentLoaded" ? s.recordAfter : "load",
    userTriggeredOnInput: W = !1,
    collectFonts: H = !1,
    inlineImages: Q = !1,
    plugins: ne,
    keepIframeSrcFn: O = () => !1,
    ignoreCSSAttributes: _e = /* @__PURE__ */ new Set([]),
    errorHandler: Fe
  } = s;
  Lh(Fe);
  const j = G ? window.parent === window : !0;
  let q = !1;
  if (!j)
    try {
  ...
  C !== void 0 && b.mousemove === void 0 && (b.mousemove = C), re.reset();
  const me = h === !0 ? {
    color: !0,
    date: !0,
    "datetime-local": !0,
    ...
    select: !0,
    password: !0
  } : d !== void 0 ? d : { password: !0 }, oe = Hi(g);
  Ah();
  let ks, hr = 0;
  const Ps = (A) => {
    for (const te of ne || [])
      te.eventProcessor && (A = te.eventProcessor(A));
  ...
  z = (A, te) => {
    var U;
    const B = A;
    if (B.timestamp = Kt(), (U = we[0]) != null && U.isFrozen() && B.type !== R.FullSnapshot && !(B.type === R.IncrementalSnapshot && B.data.source === I.Mutation) && we.forEach((K) => K.unfreeze()), j)
      e == null || e(Ps(B), te);
    else if (q) {
      const K = {
        type: "rrweb",
    ...
    if (B.type === R.FullSnapshot)
      ...
      if (B.data.source === I.Mutation && B.data.isAttachIframe)
        return;
      hr++;
      const K = r && hr >= r, N = t && B.timestamp - ks.timestamp > t;
      (K || N) && Ft(!0);
    }
  };
  const at = (A) => {
  ...
  for (const A of ne || [])
    A.getMirror && A.getMirror({
      ...
      crossOriginIframeStyleMirror: ye.crossOriginIframeStyleMirror
    });
  const fr = new uf();
  Ar = new af({
    recordCanvas: k,
  ...
  Ft = (A = !1) => {
    ...
    z(
      ...
      A
    ), ge.reset(), lt.init(), we.forEach((U) => U.lock());
    const te = $a(document, {
      mirror: re,
      blockClass: i,
      blockSelector: n,
      ...
      inlineImages: Q,
      onSerialize: (U) => {
        vo(U, re) && ye.addIframe(U), Io(U, re) && ge.trackLinkElement(U), os(U) && lt.addShadowRoot(v.shadowRoot(U), document);
      },
      onIframeLoad: (U, B) => {
        ye.attachIframe(U, B), lt.observeAttachShadow(U);
      },
      onStylesheetLoad: (U, B) => {
        ge.attachLinkElement(U, B);
      },
      keepIframeSrcFn: O
    });
    if (!te)
    ...
    z(
      {
        ...
        data: {
          node: te,
          initialOffset: yo(window)
        }
      },
      A
    ), we.forEach((U) => U.unlock()), document.adoptedStyleSheets && document.adoptedStyleSheets.length > 0 && ge.adoptStyleSheets(
  ...
  try {
      ...
      return x(Jh)(
        {
          ...
          processedNodeManager: fr,
          canvasManager: Ar,
          ignoreCSSAttributes: _e,
          plugins: ((K = ne == null ? void 0 : ne.filter((N) => N.observer)) == null ? void 0 : K.map((N) => ({
            observer: N.observer,
            options: N.options,
            callback: (pr) => z({
              type: R.Plugin,
    ...
    ye.addLoadListener((B) => {
      try {
        A.push(te(B.contentDocument));
      } catch (K) {
        console.warn(K);
      }
    });
    const U = () => {
      Ft(), A.push(te(document)), qt = !0;
    };
    return ["interactive", "complete"].includes(document.readyState) ? U() : (A.push(
      Z("DOMContentLoaded", () => {
        z({
          type: R.DomContentLoaded,
          data: {}
        }), T === "DOMContentLoaded" && U();
      })
    ), A.push(
      Z(
        "load",
...
Ie.freezePage = () => {
  we.forEach((s) => s.freeze());
};
Ie.takeFullSnapshot = (s) => {
  if (!qt)
...
const { addCustomEvent: Wf } = Ie, { freezePage: Gf } = Ie, { takeFullSnapshot: jf } = Ie;
export {
  R as EventType,
  I as IncrementalSource,
  X as MouseInteractions,
  Wf as addCustomEvent,
  Gf as freezePage,
  Ri as mirror,
  Ie as record,
  jf as takeFullSnapshot
};
